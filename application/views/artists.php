                ...
                <div class="row">
                    ...
                    foreach($results['data'] as $row){
                       if($row->artist_account_name_artist == $this->session->artist_account_name_artist){
                           ...
                           $view_profile = '<a class="btn btn-primary" href="./Dash/artist/'.$row->artist_id.' ">View Profile</a>';
                       }
                       else{
                        ...
                        <div class="card mb-4">
                          <div class="card-body">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="'.$row->artist_social_picture.'" alt=".$artist_account_name_artist."></div>
