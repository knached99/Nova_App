          ...
          <div class="col-lg-6 px-lg-4">
            <div class="card">
              ...
              <div class="card-body p-lg-5">
                ...
                else if(isset($code_send_failed)){
                  echo $code_send_failed;
                }
                ?>
                <p class="text-muted text-sm mb-5">Forgot your password? No worries, we can help, just follow the instructions to reset your password</p>
              <?php
              echo form_open();
              ?>
                  <div class="form-floating mb-3">
                    <input class="form-control" name="artist_account_email" type="text" placeholder="johndoe@anymail.net" value="<?php echo set_value('artist_account_email')?>">
                    <small class="text-danger"><?php echo form_error('artist_account_email');?></small>
                    <label for="email">Enter your email</label>
                  </div>

                  <div class="form-group">
                    <button class="btn btn-primary" id="register" type="submit" name="registerSubmit">Send Reset Request</button>
                    &nbsp; &nbsp; &nbsp; <a href="signin" style="font-size: 15px;"><i class="fa fa-arrow-circle-left fa fa-lg"></i> go back</a>
                  </div>
              <?php echo form_close();?>
              </div>
