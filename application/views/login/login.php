          ...
          <div class="col-lg-6 px-lg-4">
            <div class="card">
              ...
              ?>
                ...
                ?>
                <p class="text-muted text-sm mb-5">What are you waiting for? Millions of people are waiting to hear your music!</p>
                <?php
                echo form_open();
                ?>

                  <div class="form-floating mb-3">
                    <input class="form-control"  name="artist_account_email" type="email" placeholder="johndoe@anymail.net" value="<?php echo set_value('artist_account_email')?>">
                    <small class="text-danger"><?php echo form_error('artist_account_email')?></small>
                    <label for="artist_account_email">Email</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input class="form-control" name="artist_account_password" type="password" placeholder="Password">
                    <small class="text-danger"><?php echo form_error('artist_account_password')?></small>
              ...
              <div class="card-footer px-lg-5 py-lg-4">
                <div class="text-sm text-muted">Don't have an account? <a href="../Register/signup">Signup Here</a>.</div>
              </div>
            </div>
          </div>
  <!--  <div class="col-lg-6 col-xl-5 ms-xl-auto px-lg-4 text-center text-primary">
