      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 px-lg-4">
            <div class="card">
              ...
              <div class="card-body p-lg-5">
                <h3 class="mb-4">Enter the verification code </h3>
                <?php
                if(isset($wrong_code)){
                    echo $wrong_code;
                }
                ?>
                <p class="text-muted text-sm mb-5">Your reset token expires is valid for one minute. Once expired, you'll need to submit another password reset request</p>
                <?php
                echo form_open();
                echo $this->session->flashdata('code_resent');
                ?>
                  ...
                  <div class="form-group">
                    ...
                    &nbsp; &nbsp; &nbsp; <a href="../reset_pwd" style="font-size: 15px;"><i class="fa fa-arrow-circle-left fa fa-lg"></i> go back</a>
                    <p class="text-dark fw-normal mt-2">Did not recieve an email?</p>
                    <a href="../resend_code/<?php echo $artist_account_email;?>">resend code</a>
                  </div>
                  <?php
                  echo form_close();
                  ?>
          ...
          <div class="col-lg-6 col-xl-5 ms-xl-auto px-lg-4 text-center text-primary"><img class="img-fluid mb-4" width="300" src="img/drawkit-illustration.svg" alt="" style="transform: rotate(10deg)">
            ...
            <p class="lead text-muted">Forgot your password? No worries, we can help, just follow the instructions to reset your password</p>
          </div>
        </div>
      </div>
    </div>
