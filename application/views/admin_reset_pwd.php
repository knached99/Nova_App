            ...
            <div class="card">
              ...
              ?>
                  <div class="form-floating mb-3">
                    <input class="form-control" name="email" type="text" placeholder="novaadmin@novamusic.com" value="<?php echo set_value('email')?>">
                  ...
                  <div class="form-group">
                    ...
                    &nbsp; &nbsp; &nbsp; <a href="login" style="font-size: 15px;"><i class="fa fa-arrow-circle-left fa fa-lg"></i> go back</a>
                  </div>
              <?php echo form_close();?>
              </div>
