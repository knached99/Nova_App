...
switch($this->session->two_factor_auth_enabled){
    case 0:
        $disabled='checked';
        $unchecked='';
        break;
                ...
                <section>
                    <div class="row">
                        ...
                        <?php echo form_close();?>
                         ...
                         <div class="card mb-4">
                         <div class="card-header">
                            <h4 class="card-heading">Two Factor Authentication
                                <p data-bs-toggle="tooltip" data-bs-placement="bottom" title="When this feature is enabled, every time you login, a 2fa code is sent to you ">
                            ...
                            <?php 
                            echo $this->session->flashdata('enable_2fa');
                            echo $this->session->flashdata('disable_2fa');
                            echo form_open('../index.php/Dash/two_factor_auth');
                            ?>
                              <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-12 mt-3">
                                            <label class="checkbox-inline text-primary fw-normal" style="padding-right:20px;">
                                                <input id="inlineCheckbox1" type="radio" value="1" name="2fa" <?php if(isset($enabled)){ echo $enabled;} else{ echo $unchecked;}?>> Enable Two-Factor Authentication <i class="fas fa-lock"></i>
                                            </label>
                                            <label class="checkbox-inline text-primary fw-normal" style="padding-right:20px;">
                                            <input id="inlineCheckbox2" type="radio" value="0" name="2fa" <?php if(isset($disabled)){ echo $disabled;} else{ echo $unchecked;}?>>    Disable Two-Factor Authentication  <i class="fas fa-unlock"></i>
                                            </label>
