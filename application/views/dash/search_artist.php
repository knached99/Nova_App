            ...
            <div class="container-fluid px-lg-4 px-xl-5">
                ...
                <div class="row" >
                    ...
                    foreach($search['data'] as $row){
                        ...
                        echo '
                        <div class="col">
                        <a href="./Dash/artist/'.$row->artist_id.'">
                            <div class="card mb-4 textWithBlurredBg">
                                <img class="" src="'.$row->artist_social_picture.'" alt="No pic" style=" width: auto; height: 250px; object-fit: cover;">

                                <div class="card-body p-3 p-lg-3">
                                   <h5> '.$row->artist_account_name_artist.'</h5>
                                    <h6>'.$row->artist_social_genre.'</h6>
