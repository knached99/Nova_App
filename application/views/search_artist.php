        ...
        <div class="page-holder bg-gray-100">
            <div class="container-fluid px-lg-4 px-xl-5">
                ...
                <div class="page-header">
                    ...
                    ?>
                    <a href="artists" class="p-5 m-5 text-primary fw-bold" style="font-size: 18px;"><i class="fas fa-arrow-circle-left"></i> back </a>
                </div>
                ...
                <div class="row" >
                    ...
                    foreach($search['data'] as $row){
                        ...
                        <div class="col">
                            <div class="card mb-4">
                                <img class="card-img-top" src="'.$row->artist_social_picture.'" alt="No pic" style=" width: auto; height: 250px; object-fit: cover;">

                                <div class="card-body p-3 p-lg-3">
                                    '.$row->artist_account_name_artist.'
                                    <p class="card-text text-muted text-sm">'.$row->artist_social_genre.'</p>
                                     <a class="btn btn-primary" href="./Dash/artist/'.$row->artist_id.' ">view profile</a>
                                </div>
                            </div>
                        </div>
                        ';
