          ...
          <div class="col-lg-6 px-lg-4">
            <div class="card">
              ...
              <div class="card-body p-lg-5">
                <h3 class="mb-4">Create your new password</h3>
               <?php
               if(isset($err)){
                   echo $err;
               }
               ?>
                <p class="text-muted text-sm mb-5">Once reset, you will be able to use this new password to signin to your account</p>
                <?php echo form_open();?>
                  <div class="form-floating mb-3">
                    <input class="form-control" name="artist_account_password" type="password">
                    <small class="text-danger"><?php echo form_error('artist_account_password')?></small>
                    <label for="email">New Password</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input class="form-control" name="artist_account_password_confirm" type="password" placeholder="Password">
                    <small class="text-danger"><?php echo form_error('artist_account_password_confirm')?></small>
                    <label for="password">Retype Password</label>
                  </div>
                  <div class="form-group">
                    <button class="btn btn-primary" id="register" type="submit">Update Password</button>
                 <br><br>
                  </div>
                <?php echo form_close();?>
              </div>
